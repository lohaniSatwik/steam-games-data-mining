...
A majority-class classifier (always predicts \textit{Good}) gives Macro F1 $\approx 0.21$
and serves as the lower bound.
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\linewidth}
    \includegraphics[width=\linewidth]{figures/fig06_rf_importance.png}
    \caption{Top-25 RF feature importances (Gini).}
    \label{fig:rf_importance}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\linewidth}
    \includegraphics[width=\linewidth]{figures/fig15c_feat_separation.png}
    \caption{Mean feature difference: Good $-$ Mixed.}
    \label{fig:feat_sep}
  \end{subfigure}
  \caption{Left: RF uses price, achievements, and release-era features most.
           Right: the most separating Good--Mixed features have modest absolute
           differences ($<0.18$), confirming limited class separation.}
  \label{fig:importance_sep}
\end{figure}
